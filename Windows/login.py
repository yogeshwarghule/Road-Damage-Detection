...
class LoginPage():
    def __init__(self, root):
        ...
        self.left_frame_title = tk.Label(self.right_frame, text="Login  ", font=font, padx=5, pady=5)
        ...
        self.entry_id = tk.Entry(self.right_frame, width=36, font=font)
        ...
        self.entry_password = tk.Entry(self.right_frame, width=36, show="*", font=font)
